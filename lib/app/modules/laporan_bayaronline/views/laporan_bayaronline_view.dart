...
import 'package:bapenda_getx2_admin/app/modules/laporan_bayaronline/controllers/laporan_bayaronline_controller.dart';
...
class LaporanBayarOnlineView extends GetView<LaporanBayarOnlineController> {
  const LaporanBayarOnlineView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            GetBuilder<LaporanBayarOnlineController>(
                init: LaporanBayarOnlineController(Get.find<Api>()),
                builder: (controller) {
                  return Container(
