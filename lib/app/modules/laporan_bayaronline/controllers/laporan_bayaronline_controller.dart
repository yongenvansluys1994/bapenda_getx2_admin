...
import 'package:bapenda_getx2_admin/app/core/pdf/pdf_Laporanonline.dart';
...
class LaporanBayarOnlineController extends GetxController {
  Api api;
  LaporanBayarOnlineController(this.api);
  ...
  void populateDatalist() async {
    ...
    datalist.clear();
    //EasyLoading.show();
    final data_mentah = await api.getLaporanBayarOnline(
  ...
  Future cetakLHP() async {
    final pdfFile =
        await PdfLaporanOnline.generate(datalist, selectedDate, selectedDate_akhir);
