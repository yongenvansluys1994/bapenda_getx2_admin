...
class Laporan1View extends GetView<Laporan1Controller> {
  const Laporan1View({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          GetBuilder<Laporan1Controller>(
              init: Laporan1Controller(Get.find<Api>()),
              builder: (controller) {
                return Container(
