import 'package:bapenda_getx2_admin/app/modules/pendataan/controllers/pendataan_controller_ppj.dart';
...
class Pendataan_ppj extends StatelessWidget {
  Pendataan_ppj({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PendataanController_ppj>(
      init: PendataanController_ppj(),
      builder: (controller) {
