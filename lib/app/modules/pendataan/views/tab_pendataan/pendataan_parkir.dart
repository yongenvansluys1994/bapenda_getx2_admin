...
class Pendataan_parkir extends StatelessWidget {
  Pendataan_parkir({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PendataanController_parkir>(
      init: PendataanController_parkir(),
      builder: (controller) {
