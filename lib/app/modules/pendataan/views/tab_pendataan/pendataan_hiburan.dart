...
class Pendataan_hiburan extends StatelessWidget {
  Pendataan_hiburan({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PendataanController_hiburan>(
      init: PendataanController_hiburan(),
      builder: (controller) {
