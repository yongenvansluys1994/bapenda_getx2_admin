...
class PdfLaporan1 {
  static Future<File> generate(RxList<ModelLaporan1> laporan,
        ...
        rows[page]!.add(pw.TableRow(
          children: [
            ...
            pw.Container(
              ...
              child: pw.Center(
                child: pw.Text(
                  "${NumberFormat.currency(locale: 'id', symbol: 'Rp. ', decimalDigits: 0).format(double.parse(laporan[index].va).toInt())}",
                ),
              ),
            ),
          ],
