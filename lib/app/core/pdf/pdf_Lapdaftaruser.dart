...
class PdfLapWajibPajakTermuktahir {
  static Future<File> generate(RxList<ModelLapDaftarUser> laporan,
        ...
        rows.add(
          pw.TableRow(
            children: [
              ...
              pw.Container(
                height: 20.h,
                color: (pageData[index].nohpUsaha != ' ' &&
                        pageData[index].nohpUsaha.isNotEmpty)
                    ? PdfColor.fromInt(0xFF80C683)
                    : null,
                child: pw.Center(
                  child: pw.Align(
                      alignment: pw.Alignment.center,
              ...
              pw.Container(
                height: 20.h,
                color: (pageData[index].emailUsaha != '-' &&
                        pageData[index].emailUsaha != ' ' &&
                        pageData[index].emailUsaha.isNotEmpty)
                    ? PdfColor.fromInt(0xFF80C683)
                    : null,
                child: pw.Center(
                  child: pw.Align(
              ...
              pw.Container(
                height: 20.h,
                color: (pageData[index].pekerjaanPemilik != 'Pemilik' &&
                        pageData[index].pekerjaanPemilik != ' ' &&
                        pageData[index].pekerjaanPemilik.isNotEmpty)
                    ? PdfColor.fromInt(0xFF80C683)
                    : null,
                child: pw.Center(
                  child: pw.Align(
              ...
              pw.Container(
                height: 20.h,
                color: (pageData[index].nohpPemilik != ' ' &&
                        pageData[index].nohpPemilik.isNotEmpty)
                    ? PdfColor.fromInt(0xFF80C683)
                    : null,
                child: pw.Center(
                  child: pw.Align(
              ...
              pw.Container(
                height: 20.h,
                color: (pageData[index].emailPemilik != '-' &&
                        pageData[index].emailPemilik != ' ' &&
                        pageData[index].emailPemilik.isNotEmpty)
                    ? PdfColor.fromInt(0xFF80C683)
                    : null,
                child: pw.Center(
                  child: pw.Align(
              ...
              pw.Container(
                height: 20.h,
                color: PdfColor.fromInt(0xFF80C683),
                child: pw.Center(
                  child: pw.Align(
                      alignment: pw.Alignment.centerLeft,
    ...
    return PdfHelper.saveDocument(
        name: 'LaporanDaftarWPTermuktahir.pdf', pdf: pdf);
  }
        ...
        child: pw.Container(
          ...
          children: [
            pw.Column(
              children: [
                pw.SizedBox(height: 15.h),
                pw.Text("Laporan Daftar Wajib Pajak Termuktahir",
                    style: pw.TextStyle(
